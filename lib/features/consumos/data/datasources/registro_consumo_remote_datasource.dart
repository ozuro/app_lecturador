...
import 'package:app_lecturador/features/consumos/domain/entities/registro_consumo.dart';
...
// token
  ...
  String _buildErrorMessage(http.Response response) {
    ...
    return 'Error ${response.statusCode} al registrar consumo';
  }
  ...
  String? _normalizeBackendMessage(String message) {
    ...
    if (lower.contains('sqlstate[22001]') && lower.contains("'foto'")) {
      return 'No se pudo guardar la foto porque el servidor no admite imagenes en este formato todavia. Puedes registrar la lectura sin foto o ajustar el backend para guardar la imagen en una columna TEXT/LONGTEXT o por archivo.';
    }
