...
import 'package:app_lecturador/features/consumos/presentation/providers/editar_consumo/edit_provider.dart';
...
class _EditConsumoPageState extends ConsumerState<EditConsumoPage> {
  ...
  void initState() {
    ...
    _habilitarLecturaAnterior =
        (widget.conexion.lectura?.consumoAnterior ?? 0) > 0;
      ...
      child: Column(
        ...
        children: [
          ...
          if (_selectedImage != null) ...[
            ...
            _NetworkPhotoPreview(
                imageUrl: _resolvePhotoUrl(widget.conexion.lectura!.fotoUrl!)),
            const SizedBox(height: 12),
          ],
          Wrap(
            spacing: 10,
