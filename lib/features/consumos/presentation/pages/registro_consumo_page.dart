...
import 'package:app_lecturador/features/consumos/presentation/providers/registro_consumo/registro_consumo_provider.dart';
          ...
          Wrap(
            ...
            children: [
              FilledButton.icon(
                ...
                label: Text(
                    _selectedImage == null ? 'Tomar foto' : 'Cambiar foto'),
